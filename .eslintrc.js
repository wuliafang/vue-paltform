...
module.exports = {
  ...
  rules: {
    'vue/script-indent': ['off', 2, { // script标签缩进设置
      'baseIndent': 1,
      'switchCase': 0,
      'ignores': []
    }],
    'vue/max-attributes-per-line': [2, { // 单行 属性
      'singleline': 8,
      'multiline': {
        'max': 10,
        'allowFirstLine': true
    ...
    // 'vue/v-bind-style': [1, 'shorthand' | 'longform'],
    'vue/attributes-order': ['off', { // 标签里 attributes 先后顺序
      'order': [
        'DEFINITION',
        'LIST_RENDERING',
        'CONDITIONALS',
    ...
    'vue/html-quotes': ['off', 'double' | 'single'],
    ...
    */
    ...
    // 'brace-style': ['error', 'stroustrup', { 'allowSingleLine': false }], // 大括号风格
    ...
    // "indent": [2, 4],//缩进风格
    'jsx-quotes': [0, 'prefer-single'], // jsx使用单引号
